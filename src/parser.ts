...
export interface SymbolType extends BaseToken { type: Types.SYMBOL, name: string }
...
export type Atom = SymbolType | NumberType | StringType | BooleanType | FunctionType | NilType;
...
export function createSymbol(name: string, line:number = 0): SymbolType {return { type: Types.SYMBOL, name: name, line: line }}
